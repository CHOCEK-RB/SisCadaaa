<script lang="ts">
  ...
  import { columns } from "$lib/components/tables/secretary/teachers/teacher-columns";
  import DataTable from "$lib/components/tables/secretary/teachers/data-table.svelte";
...
<div class="p-4 md:p-8">
  <h1 class="mb-4 text-2xl font-bold">Gestión de Profesores</h1>
