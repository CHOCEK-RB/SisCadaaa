<script lang="ts">
  ...
  const navLinks = $derived([
    {
      title: "Información",
      href: `/admin/groups/${page.params.id}`,
      icon: InfoIcon,
    },
    {
      title: "Horario",
      href: `/admin/groups/${page.params.id}/schedule`,
      icon: CalendarIcon,
    },
    {
      title: "Notas",
      href: `/admin/groups/${page.params.id}/grades`,
      icon: SquareCheckIcon,
    },
    {
      title: "Asistencia",
      href: `/admin/groups/${page.params.id}/attendance`,
      icon: UsersIcon,
    },
  ]);
</script>
