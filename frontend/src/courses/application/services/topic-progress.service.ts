...
import { ICourseAcademicRepository } from 'src/courses/domain/repositories/icourse_academic.repository';
...
export class TopicProgressService {
	constructor(
		...
		@Inject(ICourseAcademicRepository)
		private readonly academicCourseRepo: ICourseAcademicRepository,
